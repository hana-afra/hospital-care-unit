#ifndef INTENSIVECAREUNIT_H_INCLUDED
#define INTENSIVECAREUNIT_H_INCLUDED
...
class IntensiveCareUnit
{
    public:
        ...
        void admitPatient(const Patient&);
        Patient findPatient(const long int& );// it returns the patient so the nurse and doctor can have access to its info
    ...
    private:
        ...
        HashTable<Patient> monitoringSystem;
...
#endif // INTENSIVECAREUNIT_H_INCLUDED
